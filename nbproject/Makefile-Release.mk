...
${OBJECTDIR}/src/KC_Storage.o: src/KC_Storage.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/KC_Storage.o src/KC_Storage.cpp

${OBJECTDIR}/src/kc_storage_constants.o: src/kc_storage_constants.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/kc_storage_constants.o src/kc_storage_constants.cpp

${OBJECTDIR}/src/kc_storage_types.o: src/kc_storage_types.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/kc_storage_types.o src/kc_storage_types.cpp
...
${OBJECTDIR}/src/KC_Storage_nomain.o: ${OBJECTDIR}/src/KC_Storage.o src/KC_Storage.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/KC_Storage_nomain.o src/KC_Storage.cpp;\
	else  \
...
${OBJECTDIR}/src/kc_storage_constants_nomain.o: ${OBJECTDIR}/src/kc_storage_constants.o src/kc_storage_constants.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/kc_storage_constants_nomain.o src/kc_storage_constants.cpp;\
	else  \
...
${OBJECTDIR}/src/kc_storage_types_nomain.o: ${OBJECTDIR}/src/kc_storage_types.o src/kc_storage_types.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/kc_storage_types_nomain.o src/kc_storage_types.cpp;\
	else  \
